...
- The files `.env`, `sessions.json`, `bot.log` and `releases/` hold data specific to your instance (tokens, session IDs, logs, compiled APKs) and are intentionally excluded from git. Do not share them or upload them to any repository.
